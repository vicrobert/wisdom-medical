...
public class HospitalRationalAnalysisServiceImpl implements HospitalRationalAnalysisService {
	...
	public HospitalViewModel hospitalStructureTree(Long hospitalId) {
		HospitalViewModel hospVm = new HospitalViewModel(hospitalService.getHospital(hospitalId).orElseGet(()->{return null;}));
...
//	}
	...
	public DeptL2ContrastBarViewModel getHospitalDeptL2ContrastBar(Long hospitalId1, Long hospitalId2) {
		...
		HospitalVo hosp1 = hospitalService.getHospital(hospitalId1).orElseGet(()->{return null;});
		HospitalVo hosp2 = hospitalService.getHospital(hospitalId2).orElseGet(()->{return null;});
		if (hosp1 == null) {
			return null;
		}
